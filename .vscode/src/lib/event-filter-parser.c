...
#line 11 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
...
#line 247 "event-filter-parser.c"
...
{
       0,   198,   198,   199,   202,   203,   204,   205,   206,   209,
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* filter: expr  */
#line 198 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { state->output = (yyvsp[0].node); }
#line 1535 "event-filter-parser.c"
    break;

  case 3: /* filter: %empty  */
#line 199 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { state->output = NULL; }
#line 1541 "event-filter-parser.c"
    break;

  case 4: /* expr: expr AND expr  */
#line 202 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
...
#line 203 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.node) = logic(state, (yyvsp[-2].node), (yyvsp[0].node), EVENT_FILTER_OP_OR); }
#line 1553 "event-filter-parser.c"
    break;

  case 6: /* expr: NOT expr  */
#line 204 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.node) = logic(state, (yyvsp[0].node), NULL, EVENT_FILTER_OP_NOT); }
#line 1559 "event-filter-parser.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 205 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.node) = (yyvsp[-1].node); }
#line 1565 "event-filter-parser.c"
    break;

  case 8: /* expr: key_value  */
#line 206 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.node) = (yyvsp[0].node); }
#line 1571 "event-filter-parser.c"
    break;

  case 9: /* key_value: key op value  */
#line 209 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                {
...
#line 1585 "event-filter-parser.c"
  ...
  case 10: /* key: TOKEN  */
#line 220 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = (yyvsp[0].str); }
#line 1591 "event-filter-parser.c"
    break;

  case 11: /* key: STRING  */
#line 221 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = str_unescape(t_strdup_noconst((yyvsp[0].str))); }
#line 1597 "event-filter-parser.c"
    break;

  case 12: /* value: TOKEN  */
#line 224 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = (yyvsp[0].str); }
#line 1603 "event-filter-parser.c"
    break;

  case 13: /* value: STRING  */
#line 225 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = (yyvsp[0].str); }
#line 1609 "event-filter-parser.c"
    break;

  case 14: /* value: AND  */
#line 226 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = "and"; }
#line 1615 "event-filter-parser.c"
    break;

  case 15: /* value: OR  */
#line 227 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = "or"; }
#line 1621 "event-filter-parser.c"
    break;

  case 16: /* value: NOT  */
#line 228 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.str) = "not"; }
#line 1627 "event-filter-parser.c"
    break;

  case 17: /* op: '='  */
#line 231 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.op) = EVENT_FILTER_OP_CMP_EQ; }
#line 1633 "event-filter-parser.c"
    break;

  case 18: /* op: '>'  */
#line 232 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.op) = EVENT_FILTER_OP_CMP_GT; }
#line 1639 "event-filter-parser.c"
    break;

  case 19: /* op: '<'  */
#line 233 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.op) = EVENT_FILTER_OP_CMP_LT; }
#line 1645 "event-filter-parser.c"
    break;

  case 20: /* op: '>' '='  */
#line 234 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.op) = EVENT_FILTER_OP_CMP_GE; }
#line 1651 "event-filter-parser.c"
    break;

  case 21: /* op: '<' '='  */
#line 235 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
                                { (yyval.op) = EVENT_FILTER_OP_CMP_LE; }
#line 1657 "event-filter-parser.c"
    break;


#line 1661 "event-filter-parser.c"
...
#line 237 "/home/gromy/Документы/Development/dovecot-core/src/lib/event-filter-parser.y"
